...
CMD_RUN="docker run --name cadvisor --network monitoring_net -d -v /:/rootfs:ro -v /var/run:/var/run:ro -v /sys:/sys:ro -v /var/lib/docker/:/var/lib/docker:ro -v /dev/disk/:/dev/disk:ro ibmcom/cadvisor-s390x:0.36.0"
